...
const unsigned numberOfAxes = 1;
const unsigned Nx = numberOfAxes * 2;
const unsigned Nu = numberOfAxes;
const unsigned Nz = Nx + Nu;
const unsigned Ny = 1;
const unsigned Nt = 3; // number of control intervals

const std::array<double, Nz> z_min = {-1, -1, -1};
const std::array<double, Nz> z_max = {-1, -1, -1};
...
static void mdlStart(SimStruct *S)
{
	...
	return_t statusFlag = qpDUNES_setup(qpData.get(), Nt, Nx, Nu, nD, &qpOptions);
	if (statusFlag != QPDUNES_OK)
	{
