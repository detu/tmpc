...
namespace tmpc :: benchmark
{
    ...
    static void BM_SyrkPotrf_blas_Static(::benchmark::State& state)
    {
    ...
    BENCHMARK_TEMPLATE(BM_SyrkPotrf_blas_Static, double, 4, 5);
    BENCHMARK_TEMPLATE(BM_SyrkPotrf_blaze_Static, double, 4, 5);
    BENCHMARK_TEMPLATE(BM_SyrkPotrf_tmpc_Static, double, 4, 5);

    BENCHMARK_TEMPLATE(BM_SyrkPotrf_blas_Static, double, 30, 60);
