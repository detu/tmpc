...
{
    TEST(MathTest, testExpm_2x2_rowMajor)
    {
        blaze::StaticMatrix<double, 2, 2, blaze::rowMajor> m {
            {1.1, 0.},
            {0., 2.2}
        };
    ...
    TEST(MathTest, testExpm_2x2_columnMajor)
    {
    ...
    TEST(MathTest, testExpm_5x5_rowMajor)
    {
    ...
    TEST(MathTest, testExpm_5x5_columnMajor)
    {
