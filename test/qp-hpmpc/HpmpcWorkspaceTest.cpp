...
namespace tmpc :: testing
{
	...
	INSTANTIATE_TYPED_TEST_CASE_P(Hpmpc_Blaze_double, TreeQpWorkspaceTest, HpmpcWorkspace<BlazeKernel<double>>);
	INSTANTIATE_TYPED_TEST_CASE_P(Hpmpc_Blaze_double, TreeQpWorkspaceSolveTest, HpmpcWorkspace<BlazeKernel<double>>);
