...
namespace tmpc :: hpipm
{
    ...
    :   ocp_qp_ipm_ws<Real>
    {
        ...
        void solve(d_ocp_qp const& qp, d_ocp_qp_sol& qp_sol, d_ocp_qp_ipm_arg const& arg)
        {
            ocp_qp_ipm_solve(qp, qp_sol, arg, *this);
        }


        void fact_solve_kkt_unconstr(d_ocp_qp const& qp, d_ocp_qp_sol& qp_sol, d_ocp_qp_ipm_arg const& arg)
        {
            fact_solve_kkt_unconstr_ocp_qp(qp, qp_sol, arg, *this);
        }
